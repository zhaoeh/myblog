...
**概念解释**   
***阻塞、非阻塞表示一个对象对访问它的线程所产生的行为，它控制自己如何响应别人***
- 阻塞：一个对象容器在某些场景下，访问它的线程必须得等待它的某些条件成立才能成功拿到响应结果，在等待意见，这个对象容器一直阻塞着访问它的线程，该线程无法做其他事情，只能等待。
...
***同步、异步表示一个对象访问其他对象所产生的行为，它控制自己如何访问别人***
